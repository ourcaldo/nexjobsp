...
const JobSidebar: React.FC<JobSidebarProps> = ({ 
  ...
  if (loadingFilters) {
    return (
      <div className="bg-primary-50 rounded-xl border border-primary-100 p-6 sticky top-32">
        ...
        <div className="space-y-4">
          {[...Array(8)].map((_, index) => (
            <div key={index} className="animate-pulse">
              ...
              <div className="space-y-2">
                <div className="h-3 bg-primary-50 rounded"></div>
                <div className="h-3 bg-primary-50 rounded w-3/4"></div>
              </div>
            </div>
          ))}
        </div>
