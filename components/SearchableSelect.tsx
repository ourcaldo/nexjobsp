  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      >
        ...
        <div className={`w-full pl-10 pr-10 py-2.5 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none appearance-none bg-white text-gray-900 flex items-center justify-between ${
