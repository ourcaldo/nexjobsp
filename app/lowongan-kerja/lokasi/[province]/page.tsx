          ...
          <nav aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2 text-sm text-gray-500">
              <li className="flex items-center">
                ...
                <Link href="/lowongan-kerja/" className="hover:text-primary-600 transition-colors">Lowongan Kerja</Link>
                <span className="mx-2">/</span>
                <span className="text-gray-900 font-medium">Lokasi: {locationName}</span>
              </li>
            </ol>
          </nav>
          <h1 className="sr-only">Lowongan Kerja di {locationName}</h1>
        </div>
