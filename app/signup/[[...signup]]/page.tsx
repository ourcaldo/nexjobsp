...
import { CheckCircle, Briefcase, Building2, Shield, Mail, Lock, ArrowLeft, Loader2 } from 'lucide-react';
...
export default function SignUpPage() {
  ...
  // Step 1: Submit email + password — create sign-up and send verification code
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      // Create a new sign-up with email and password
      await signUp.create({
        emailAddress: email,
        password,
      });
